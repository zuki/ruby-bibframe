...
module RDF
  ...
  class BF < StrictVocabulary("http://bibframe.org/vocab/")
    ...
    term :Annotation,
      ...
      type: "rdfs:Class".freeze
    term :Archival,
      comment: %(Resource that is controlled archivally.).freeze,
    ...
    term :Audio,
      ...
      type: "rdfs:Class".freeze
    term :Authority,
      comment: %(Resource reflecting key authority concepts that have defined relationships reflected in the Work and Instance.).freeze,
    ...
    term :Event,
      ...
      type: "rdfs:Class".freeze
    term :Family,
      comment: %(Controlled family name.).freeze,
      label: "Family".freeze,
    ...
    term :IntendedAudience,
      ...
      type: "rdfs:Class".freeze
    term :Jurisdiction,
      comment: %(Controlled jurisdiction \(city/government, etc.\) name.).freeze,
    ...
    term :Manuscript,
      ...
      type: "rdfs:Class".freeze
    term :Meeting,
      comment: %(Controlled corporate meeting/conference name.).freeze,
    ...
    term :NotatedMusic,
      ...
      type: "rdfs:Class".freeze
    term :Organization,
      comment: %(Controlled corporate/organization name.).freeze,
      label: "Organization".freeze,
      subClassOf: "http://bibframe.org/vocab/Agent".freeze,
      type: "rdfs:Class".freeze
    term :Person,
      comment: %(Controlled personal name.).freeze,
      label: "Person".freeze,
      subClassOf: "http://bibframe.org/vocab/Agent".freeze,
      type: "rdfs:Class".freeze
    term :Place,
      comment: %(Controlled term for a geographic area.).freeze,
      label: "Place".freeze,
      subClassOf: "http://bibframe.org/vocab/Authority".freeze,
      type: "rdfs:Class".freeze
    term :Print,
    ...
    term :Tactile,
      ...
      label: "Tactile Expression".freeze,
      subClassOf: "http://bibframe.org/vocab/Instance".freeze,
      type: "rdfs:Class".freeze
    term :Temporal,
      comment: %(Controlled term for a chronological period.).freeze,
    ...
    term :Title,
      ...
      type: "rdfs:Class".freeze
    term :Topic,
      comment: %(Controlled term for a subject/topic.).freeze,
      label: "Topic".freeze,
      subClassOf: "http://bibframe.org/vocab/Authority".freeze,
      type: "rdfs:Class".freeze
    term :Work,
    ...
    property :ansi,
      ...
      domain: "http://bibframe.org/vocab/Instance".freeze,
      label: "American National Standard Institute Number".freeze,
    ...
    property :carrierCategory,
      ...
      domain: "http://bibframe.org/vocab/Instance".freeze,
      label: "Instance carrier category".freeze,
    ...
    property :contentCategory,
      ...
      domain: "http://bibframe.org/vocab/Work".freeze,
      label: "Work content category".freeze,
      range: "http://bibframe.org/vocab/Category".freeze,
      type: "rdf:Property".freeze
    ...
    property :descriptionLanguage,
      ...
      label: "Description language process".freeze,
      range: "rdfs:Resource".freeze,
      type: "rdf:Property".freeze
    ...
    property :ean,
      ...
      domain: "http://bibframe.org/vocab/Instance".freeze,
      label: "International Article Identifier (EAN)".freeze,
      range: "http://bibframe.org/vocab/Identifier".freeze,
      subPropertyOf: "http://bibframe.org/vocab/identifier".freeze,
      type: "rdf:Property".freeze
    property :edition,
    ...
    property :generationProcess,
      comment: %(Indication of whether the description was machine generated or particular transformations that were applied.).freeze,
      label: "Description generation process".freeze,
      range: "rdfs:Literal".freeze,
      type: "rdf:Property".freeze
    property :genre,
      comment: %(Genre and other general characteristice associated with genre and form.).freeze,
      "dc:modified" => %(2014-03-21 \(New\)).freeze,
      label: "Genre, etc.".freeze,
      range: "http://bibframe.org/vocab/Category".freeze,
      type: "rdf:Property".freeze
    ...
    property :hdl,
      ...
      domain: "http://bibframe.org/vocab/Instance".freeze,
      label: "Handle for a resource".freeze,
      range: "http://bibframe.org/vocab/Identifier".freeze,
      subPropertyOf: "http://bibframe.org/vocab/identifier".freeze,
      type: "rdf:Property".freeze
    property :heldBy,
    ...
    property :isbn,
      ...
      domain: "http://bibframe.org/vocab/Instance".freeze,
      label: "International Standard Bibliographic Number".freeze,
      range: "http://bibframe.org/vocab/Identifier".freeze,
      subPropertyOf: "http://bibframe.org/vocab/identifier".freeze,
      type: "rdf:Property".freeze
    property :isbn10,
      comment: %(10 digit version of the ISBN.).freeze,
      domain: "http://bibframe.org/vocab/Instance".freeze,
      label: "International Standard Bibliographic Number".freeze,
      range: "http://bibframe.org/vocab/Identifier".freeze,
      ...
      type: "rdf:Property".freeze
    property :isbn13,
      comment: %(13 digit version of the ISBN.).freeze,
      domain: "http://bibframe.org/vocab/Instance".freeze,
      label: "International Standard Bibliographic Number".freeze,
      range: "http://bibframe.org/vocab/Identifier".freeze,
      subPropertyOf: "http://bibframe.org/vocab/isbn".freeze,
    ...
    property :iso,
      ...
      domain: "http://bibframe.org/vocab/Instance".freeze,
      label: "International Organization for Standardization standard number".freeze,
      range: "http://bibframe.org/vocab/Identifier".freeze,
      subPropertyOf: "http://bibframe.org/vocab/identifier".freeze,
      type: "rdf:Property".freeze
    property :isrc,
      comment: %(International Standard Recording Code.).freeze,
      domain: "http://bibframe.org/vocab/Instance".freeze,
    ...
    property :issueNumber,
      ...
      domain: "http://bibframe.org/vocab/Instance".freeze,
      label: "Sound recording publisher issue number".freeze,
      range: "http://bibframe.org/vocab/Identifier".freeze,
      subPropertyOf: "http://bibframe.org/vocab/identifier".freeze,
      type: "rdf:Property".freeze
    property :issuedWith,
    ...
    property :lcOverseasAcq,
      ...
      domain: "http://bibframe.org/vocab/Instance".freeze,
      label: "Library of Congress Overseas Acquisition Program number".freeze,
      range: "http://bibframe.org/vocab/Identifier".freeze,
      subPropertyOf: "http://bibframe.org/vocab/identifier".freeze,
      type: "rdf:Property".freeze
    property :lccn,
    ...
    property :legalDeposit,
      ...
      domain: "http://bibframe.org/vocab/Instance".freeze,
      label: "Copyright or legal deposit number".freeze,
      range: "http://bibframe.org/vocab/Identifier".freeze,
      subPropertyOf: "http://bibframe.org/vocab/identifier".freeze,
      type: "rdf:Property".freeze
    ...
    property :matrixNumber,
      comment: %(Master from which a specific sound recording was pressed.).freeze,
      domain: "http://bibframe.org/vocab/Instance".freeze,
      label: "Sound recording publisher matrix master number".freeze,
      range: "http://bibframe.org/vocab/Identifier".freeze,
      subPropertyOf: "http://bibframe.org/vocab/identifier".freeze,
      type: "rdf:Property".freeze
    ...
    property :musicMedium,
      ...
      label: "Medium of music performance".freeze,
      range: "rdfs:Resource".freeze,
      type: "rdf:Property".freeze
    ...
    property :musicPlate,
      ...
      domain: "http://bibframe.org/vocab/Instance".freeze,
      label: "Music publication number assigned by publisher".freeze,
      range: "http://bibframe.org/vocab/Identifier".freeze,
      subPropertyOf: "http://bibframe.org/vocab/identifier".freeze,
      type: "rdf:Property".freeze
    property :musicPublisherNumber,
      ...
      domain: "http://bibframe.org/vocab/Instance".freeze,
      label: "Other publisher number for music".freeze,
      range: "http://bibframe.org/vocab/Identifier".freeze,
      subPropertyOf: "http://bibframe.org/vocab/identifier".freeze,
      type: "rdf:Property".freeze
    ...
    property :nban,
      ...
      domain: "http://bibframe.org/vocab/Instance".freeze,
      label: "National bibliography agency control number".freeze,
      range: "http://bibframe.org/vocab/Identifier".freeze,
      subPropertyOf: "http://bibframe.org/vocab/identifier".freeze,
      type: "rdf:Property".freeze
    property :nbn,
      ...
      domain: "http://bibframe.org/vocab/Instance".freeze,
      label: "National Bibliography Number".freeze,
      range: "http://bibframe.org/vocab/Identifier".freeze,
      subPropertyOf: "http://bibframe.org/vocab/identifier".freeze,
      type: "rdf:Property".freeze
    property :notation,
    ...
    property :partNumber,
      ...
      domain: "http://bibframe.org/vocab/Title".freeze,
      label: "Part title enumeration".freeze,
      range: "rdfs:Literal".freeze,
      type: "rdf:Property".freeze
    property :partOf,
    ...
    property :postalRegistration,
      ...
      type: "rdf:Property".freeze
    property :precededBy,
      comment: %(Resource that is precedes the resource being described \(e.g., is earlier in time or before in narrative\).).freeze,
    ...
    property :publisherNumber,
      ...
      domain: "http://bibframe.org/vocab/Instance".freeze,
      label: "Other publisher assigned number".freeze,
      range: "http://bibframe.org/vocab/Identifier".freeze,
      subPropertyOf: "http://bibframe.org/vocab/identifier".freeze,
      type: "rdf:Property".freeze
    ...
    property :relatedTo,
      ...
      "dc:modified" => %(2014-04-10 \(Range updated\)).freeze,
      domain: "http://bibframe.org/vocab/Resource".freeze,
      label: "Related to another resource".freeze,
      range: "http://bibframe.org/vocab/Resource".freeze,
      type: "rdf:Property".freeze
    ...
    property :stockNumber,
      ...
      domain: "http://bibframe.org/vocab/Instance".freeze,
      label: "Stock number for acquisition".freeze,
      range: "http://bibframe.org/vocab/Identifier".freeze,
      subPropertyOf: "http://bibframe.org/vocab/identifier".freeze,
      type: "rdf:Property".freeze
    property :strn,
    ...
    property :studyNumber,
      ...
      domain: "http://bibframe.org/vocab/Instance".freeze,
      label: "Original study number assigned by the producer of a computer file".freeze,
      range: "http://bibframe.org/vocab/Identifier".freeze,
      subPropertyOf: "http://bibframe.org/vocab/identifier".freeze,
      type: "rdf:Property".freeze
    ...
    property :urn,
      ...
      domain: "http://bibframe.org/vocab/Instance".freeze,
      label: "Uniform resource number".freeze,
      range: "http://bibframe.org/vocab/Identifier".freeze,
      subPropertyOf: "http://bibframe.org/vocab/identifier".freeze,
      type: "rdf:Property".freeze
